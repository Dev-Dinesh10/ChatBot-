...
import { Zap, Eye, EyeOff, Mail, Lock, User, ArrowRight, AlertCircle, CheckCircle2 } from 'lucide-react';
...
export default function Register({ onLogin, goToLogin }) {
    ...
    const inputClass = "w-full bg-white/[0.04] border border-white/[0.08] rounded-xl pl-10 pr-4 py-3 text-sm text-gray-200 placeholder-gray-600 outline-none focus:border-violet-500/60 focus:ring-1 focus:ring-violet-500/30 transition-all";
                ...
                <div className="bg-[#111114] border border-white/[0.08] rounded-3xl p-8 shadow-2xl">
                                ...
                                <div className="space-y-1.5 pt-1">
                                    <div className="flex gap-1">
                                        {[1, 2, 3].map(i => (
                                            <div
                                                ...
                                                style={{ background: strengthScore >= i ? strengthColor : '#1f2937' }}
                                            />
                                        ))}
                                    </div>
                                    <div className="flex items-center gap-3 text-xs">
                                        {[
                                            ...
                                            <span key={label} className={`flex items-center gap-1 transition-colors ${ok ? 'text-emerald-400' : 'text-gray-600'}`}>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full bg-white/[0.04] border rounded-xl pl-10 pr-10 py-3 text-sm text-gray-200 placeholder-gray-600 outline-none focus:ring-1 transition-all ${form.confirm && form.confirm !== form.password
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center">
                            <span className="bg-[#111114] px-3 text-xs text-gray-600">Already have an account?</span>
                        </div>
                    </div>
